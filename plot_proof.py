...
for dataset in datasets:
    ...
    #for (x1,x2),(y1,y2) in zip(itertwo(xx),itertwo(yy)):
    #    #draw arrow, where the head ends at the second point
    #    plt.arrow(x1,y1,x2-x1,y2-y1,head_width=0.01,head_length=0.01,color=dataset_to_color(dataset),alpha=0.3,head_starts_at_zero=True)
    #    plt.plot([x1,x2],[y1,y2],color=dataset_to_color(dataset),alpha=0.3)
...
yt=[0.27,0.30,0.33,0.36]
yl=[r"$27\%$",r"$30\%$",r"$33\%$",r"$36\%$"]
plt.yticks(yt,yl)
